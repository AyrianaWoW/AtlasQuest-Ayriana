...
Inst44Quest2_Note = "The Dawnstone Plans are in the building "..YELLOW.."[a]"..WHITE.." on the box."
...
Inst44Quest3_Note = "The Deed to Ravenshire is on the table behind Regent-Lady Celia Harlow and Regent-Lord Mortimer Harlow and next to the Harlow Family Chest"..YELLOW.."[7]"..WHITE.."."
...
Inst44Quest4_Note = "The Book of Ur is in the building "..YELLOW.."[b]"..WHITE..", go right, on the table (south side)."
...
Inst44Quest5_Note = "Bring 1 Large Glowing Shard as you will need 1 for prequest. Enchanters have them or auction house can help as it should be cheap to purchase."
...
Inst44Quest7_Note = RED.."(Mage ONLY)"..WHITE.." Mage Theramore teleport quest.\nThe Manuscript on Hydromancy II is in the building "..YELLOW.."[b]"..WHITE..", go right, look on the dresser (south side)."
